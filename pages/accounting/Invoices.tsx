...
import styles from "../../styles/accounting/Invoices.module.css";
...
const Invoices = () => {
  ...
  return (
    <div className={styles.container}>
        ...
        <div className="col-12">
          <div className={Styles.date}>
            <div style={{ gap: "5px" }}>
              ...
              <span>
                Sell Satus <img src="/assets/down.svg" alt="" />
              </span>
              <span>
      ...
      <Table tableName={`Invoices`} tableTitle={tableTitle}>
        <tbody>
          <tr>
