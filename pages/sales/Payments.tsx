...
import styles from "../../styles/sales/Payments.module.css";
...
const getEmplyeeData = [
  ...Array(12).fill({
    ...
    payment_date: "31/12/2022",
    payment_methood: "Bank Transfer",
    amount: "INR 1,00,000",
    recorded_by: "Admin",
    project: "Website",
    note:"Done",
...
const Payments = () => {
  ...
  return (
    <div className={styles.container}>
      <h5 className={styles.headerText}>Payment</h5>
      ...
      <Table tableName={`Payment`} tableTitle={tableTitle}>
        <tbody>
          {/* <tr>
