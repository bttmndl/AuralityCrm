...
import Styles from "@/styles/contact/consumer.module.css";
...
const Consumers = () => {
  ...
  return (
    <div className="container">
      {!isClicked && (
        <>
          <NavTool title="Consumers" date={true}  buttons={naveToolData?.button} dropdownSelector={naveToolData?.dropDownSelector}/>
          <Table tableName={"Consumers"} tableTitle={tableTitle}>
            <tr>
